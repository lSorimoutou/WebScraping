        ...
        >
          ...
          <List>
            ...
            {[
              ...
              {
                title: "I.FONCTIONNEMENT GLOBAL DE L’APPLICATION WEB",
                icon: faPencilRuler
              },
              { title: "II.CHOIX MISE EN ŒUVRE ", icon: faCheckSquare },
              { title: "III. LES DONNÉES RÉCUPÉRER ", icon: faDatabase },
              { title: "IV. SOURCES", icon: faBook }
            ].map((obj, index) => (
              <Link
                to={`${index}`}
                spy={true}
            ...
            <Container maxWidth="lg">
              ...
              <section id="1">
                ...
                <p>
                  ...
                  recherche sur la page web. Après avoir validé la recherche, le
                  nom du produit entré sera envoyé à l'api Java.
                </p>
                <p>
                  Par le biais de la bibliothèque <strong>sélénium</strong>, on
                  va extraire les données du site marchand monoprix. Java va
                  ensuite crée un objet avec toutes les informations scraper,
                  puis en utilisant la bibliothèque <strong>Gson</strong>, on
                  convertit l'objet au format json et on l'envoie au client
                  (JavaScript). Le diagramme d'activité suivant résume le
              ...
              <section id="2">
                ...
                <p>
                  ...
                  œuvre pour la conception de l’application web. Pour ce faire,
                  la partie sera divisé en deux sous parties. La première
                  détaillera les choix fait dans la partie Front-End(côté client
                  avec Javascript) de l’application. La seconde partie
                  détaillera les choix de la partie Back-End(côté serveur avec
                  Java).
                </p>
                <h4>1. Front-End</h4>
                <h5>A. React</h5>
                <p>
                  ...
                  JavaScript React. Il s'agit d'une bibliothèque développée par
                  Facebook afin de faciliter la création d'application web via
                  la création de composant autonomes qui maintiennent leur
                  propre état. J'ai choisi d'utiliser cette bibliothèque afin de
                  facilité la conception de la partie front-end.
                </p>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={6}>
                    ...
                    <p>
                      ...
                      méthodes spécifiques au DOM. En important ce module, on a
                      accès à divers méthode comme render().
                      <br />
                      <br />
                    ...
                    <p>
                      Lors de la mise à jour, React DOM compare l’élément et ses
                      enfants avec la version précédente, et applique uniquement
                      les mises à jour DOM nécessaires.
                    </p>
                  </Grid>
                  <Grid item xs={6}>
                    <SyntaxHighlighter
                ...
                <p>
                  ...
                  mon utilisation de React. JSX est une extension syntaxique de
                  JavaScript uniquement là pour faciliter l’expérience de
                  développement.
                </p>
                ...
                <p>
                  ...
                  langage Sass. La syntaxe SCSS a été choisi, car elle est assez
                  similaire au Css. J'ai choisi de faire mes feuilles de styles
                  en Sass juste par pure curiosité pour ce langage qui fait
                  parler de lui.
                </p>
                ...
                <p>
                  ...
                  son <strong>xpath</strong> (langage de requête pour localiser
                  une portion d'un document XML) et il est aussi capable{" "}
                  <strong>d'extraire les données stockées</strong> dans ces
                  différents éléments.
                </p>
                <Grid container spacing={3}>
                  <Grid item xs={6}>
                    <p>
                      Ici par exemple, on recherche un élément div possédant la
                      classe « catalog-page__statistic ». Ce div contient le
                      nombre de produit trouvé sur le site marchand. Si ce
                      nombre est égal à 0, pas besoin de faire de recherche, on
                      arrête le programme et on envoie un message au JavaScrpit
                ...
                <p>
                  ...
                  être chargés lors du démarrage de celui-ci. Par défaut, quand
                  on demande à un navigateur d'afficher une page web, cette
                  dernière charge toutes les ressources et donc toutes les
                  images. Ce n'est pas vraiment optimal, c'est pour cela qu'a
                  été inventé le « lazy-loading ». L'image est chargée seulement
                  quand elle est visible sur la page ou utiliser par
                  l'utilisateur.
                </p>
                <p>
                  Dans le cas du Web Scraping avec selenium, j'ai été confronté
                  à ce problème. Quand je recherchais le lien de toutes les
                  images de la page, je ne recevais que le lien des images en
                  haut page. Les autres images n'avaient pas encore été chargé.
                </p>
                <Grid container spacing={3}>
                  <Grid item xs={6}>
                    <p>
                      Pour régler ce problème, on réalise un scroll vers le bas
                      de page et on attend que les images soient chargées.
                    </p>
                  </Grid>
                  <Grid item xs={6}>
                    <SyntaxHighlighter
                ...
                <p>
                  ...
                  Javascript de la page (contrairement à Jsoup que nous verrons
                  plus tard).
                </p>
                <p>
                  Selenium est très lent, il faut attendre dans la premier temps
                  le chargement de la page à l'état "complete". Puis, il faut
                  scroller la page vers le bas (pour résoudre le problème du
                  "lazy-loading" des images). Il était donc important de trouver
                  un moyen d'optimiser l'application. Pour rendre selenium plus
                  rapide, commencé par utiliser des selecteurs rapide. En effet,
                  selenium donne la possibilité d'utiliser différent type de
                  selecteurs (trier par leur vitesse) :
                  <ul>
                    <li>
                      <strong>ID selector</strong>
                      <p>
                        C'est le sélecteur le plus rapide de selenium, il
                        utilise le
                        <SyntaxHighlighter
                          language="js"
                          style={tomorrow}
                    ...
                    <li>
                      <strong>NAME selector</strong>
                      <p>Il fonctionne si l'élément à un attribut NAME</p>
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>XPATH selector</strong>
                      <p>
                        Le selecteur XPAH est le selecteur le plus simple a
                        utilisé, mais aussi le plus lent.
                      </p>
                    </li>
                  </ul>
                </p>
                ...
                <p>
                  Dans l'application, on utilise JSOUP afin d'aller chercher la
                  description, les informations nutritionnels. Pour chaque
                  produit qu'on trouve (avec selenium), on se rend sur la page
                  du produit avec JSOUP pour prendre les informations dont nous
                  avons besoin. On utilise plutôt JSOUP que selenium car sur
                  cette page, on n'a pas besoin de JavaScript.
                  <SyntaxHighlighter
                    language="java"
                    style={tomorrow}
                    showLineNumbers
                ...
                <Grid container spacing={3}>
                  <Grid item xs={6}>
                    <p>
                      ...
                      champs « _jsonInString » est null. Si ce n’est pas le cas,
                      on peut convertir la liste d’objet à l’intérieur en
                      fichier json.
                    </p>
                    <ul>
                      <li>
    ...
    if(this._jsonInString != null){
        ...
        return "Nothing";
              ...
              <section id="3">
                ...
                <p>
                  Pour un produit donnée, les données récupérer par web scraping
                  sont :
                </p>
                <ul>
              ...
              <section id="4">
                ...
                <h5>FONCTIONNEMENT GLOBAL DE L’APPLICATION WEB</h5>
                <ul>
                  <li>
